...
```{r, eval=TRUE}
midwest_zipMap <- rgdal::readOGR("midwest.shp",stringsAsFactors=F)
```
...
```{r, eval=TRUE}
nationalcap_zipMap <- rgdal::readOGR("capital.shp",stringsAsFactors=F)
```
...
```{r, eval=TRUE}
northeast_zipMap <- rgdal::readOGR("northeast.shp",stringsAsFactors=F)
```
...
```{r, eval=TRUE}
southeast_zipMap <- rgdal::readOGR("southeast.shp",stringsAsFactors=F)
```
